...
.bar select{background:#0a0e16;border:1px solid var(--line);color:var(--txt);border-radius:8px;padding:7px 10px;outline:none}
...
.daylink{fill:#8b98a9;cursor:default}
.daylink.live{cursor:pointer}
.daylink.live:hover{fill:var(--gold);text-decoration:underline}
.tip{position:absolute;pointer-events:none;background:#0a0e16;border:1px solid var(--gold);
...
.secbar input{background:#0a0e16;border:1px solid var(--line);color:var(--txt);border-radius:8px;padding:7px 12px;outline:none;min-width:240px}
.secbar select{background:#0a0e16;border:1px solid var(--line);color:var(--txt);border-radius:8px;padding:7px 10px;outline:none}
...
table tr:hover td{background:#0e1420}
.bh{font-weight:700}
.ld{font-weight:600}
...
.csel-head select{background:#0a0e16;border:1px solid var(--line);color:var(--txt);border-radius:8px;padding:7px 10px;outline:none}
...
#csearch{width:100%;background:#0a0e16;border:1px solid var(--line);color:var(--txt);border-radius:8px;padding:8px 12px;outline:none;margin-bottom:8px}
...
const COMPARE_COLORS=['#e0483b','#1a9e5a','#e8b339','#5b8def','#a855f7','#22d3ee','#f97316','#ec4899'];
...
function renderSector(){
  ...
  el.innerHTML=`<svg viewBox="0 0 ${W} ${H}" preserveAspectRatio="xMidYMid meet">
    <defs><linearGradient id="${gid}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#5b8def" stop-opacity="0.30"/><stop offset="1" stop-color="#5b8def" stop-opacity="0"/>
    </linearGradient></defs>
