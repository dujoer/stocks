        ...
        "cards": [
            {
                ...
                "func": "v5 全市场域 ＋ 先验固定因子集：A 股正股全量（剔 ST/退 与 20 日均额&lt;3000万）在「距52周高回撤≥18% 且未破 MA60×0.75」的深跌域内，用 9 个先验固定因子做日内横截面分位排序，按<b>域内分位</b>定档（A=前10% / B=10~25%）。方向全部为「距低点越近·量能越枯竭·波动越低·箱体越窄·均线越未修复·市值越小」。附特征功效实验室（14 节样本外实证页）与 v5 方法论常驻页。",
                "rel": "← 本地全市场日K 横截面分位 → 输出域内分位档 + 买卖点；选股能力与局限以 lab.html 为准",
            ...
            },
            {
                ...
                "func": "从<b>三源并集</b>（机构底仓 × 龙虎榜活跃 × 强势股）中筛出可反复做 T 的标的：箱体区间 / 网格 5 档价位 / 波段买卖区 / 止损 / 仓位建议。<b>打分 v6</b>：9 个先验固定因子（箱体窄 / 带宽低 / 均线粘合 / 波动规律 / 振幅适中 / ATR 适中 / 横盘 / 支撑被验 / 流动性）取当日域内横截面分位、等权 × 100，档位 = 分位（A 前 10% / B 前 25%），解禁与减持直接进 D。<b>大盘环境门控</b>：强势放行 A/B/C、震荡放行 A/B、弱势只放行 A 档并附加「非高位 · MA20 未明显下行 · 箱体不过宽」，仓位按环境打 0.55~1.0 折，破位不放行新开仓；卖区按 1.2×ATR 设定。<b>方向须与环境配对</b>：指数近 20 日偏弱/弱势做<b>反T</b>（先低吸后高抛）、偏强做<b>正T</b>（先高抛后低吸补回）——这是实验室里唯一能让期望收益转正的窗口，反向配对为最差档。证据见 <a href='web/tplus/lab.html'>做T池 · 特征功效实验室</a>。",
                "rel": "← 机构底仓池（公募 / 社保 / 险资） → 数据中心（积累历史）｜<a href='web/tplus/lab.html'>特征功效实验室</a>",
...
RELATIONSHIPS = [
    ...
    ("📈 底部反转观察池", "← 全市场深跌域（离线日K）→ 先验固定因子集横截面分位", "→ 数据中心（查历史观察池）"),
