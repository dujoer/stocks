    ...
    },
    {
        ...
        "cards": [
            ...
            },
            {
                ...
                "func": "从<b>三源并集</b>（机构底仓 × 龙虎榜活跃 × 强势股）中筛出可反复做 T 的标的：箱体区间 / 网格 5 档价位 / 波段买卖区 / 止损 / 仓位建议。<b>大盘环境门控</b>：强势放行 A/B/C、震荡放行 A/B、弱势只放行 A 档并附加「非高位 · MA20 未明显下行 · 箱体不过宽」，仓位按环境打 0.55~1.0 折，破位不放行新开仓；卖区按 1.2×ATR 设定（不再死等箱体上沿）。",
