...
.meta { margin:12px 0 22px; font-size:12px; color:#6b7280; line-height:1.7; }
.meta b { color:#b8893b; }
...
.section h2 { font-size:17px; margin:0 0 8px; color:#1c2430; display:flex; align-items:center; gap:8px; }
.section h2:before { content:""; width:4px; height:16px; background:#b8893b; border-radius:3px; }
.sub2 { font-size:13px; color:#6b7280; margin:2px 0 10px; line-height:1.7; }
.chiprow { display:flex; flex-wrap:wrap; gap:10px; margin:10px 0; }
.chip { flex:1; min-width:112px; background:linear-gradient(135deg,rgba(184,51,42,.08),rgba(184,51,42,.03));
  border:1px solid rgba(184,51,42,.20); border-radius:14px; padding:12px 10px; text-align:center; }
.chip.g { background:linear-gradient(135deg,rgba(16,158,90,.08),rgba(16,158,90,.03));
  border-color:rgba(16,158,90,.22); }
.chip.n { background:linear-gradient(135deg,rgba(184,137,59,.10),rgba(184,137,59,.03));
  border-color:rgba(184,137,59,.30); }
.chip .k { font-size:11px; color:#6b7280; }
.chip .v { font-size:21px; font-weight:800; color:#1c2430; margin:3px 0 1px; }
.chip .hl { font-size:10px; color:#8a929c; }
table { width:100%; border-collapse:collapse; font-size:13px; background:rgba(0,0,0,.03);
  border:1px solid rgba(0,0,0,.05); border-radius:12px; overflow:hidden; margin:8px 0; }
th,td { padding:7px 10px; text-align:left; border-bottom:1px solid rgba(0,0,0,.04); }
th { background:rgba(20,30,50,.06); color:#3a4048; font-weight:600; font-size:12px; }
tr:last-child td { border-bottom:none; }
td.num,th.num { text-align:right; font-variant-numeric:tabular-nums; }
.up { color:#d8392b; font-weight:700; } .down { color:#1a9e5a; font-weight:700; }
.flat { color:#8a929c; }
...
.amberbox b { color:#b8893b; }
.upbox { border-left:4px solid #b8332a; } .downbox { border-left:4px solid #1a9e5a; }
.vrbar { display:inline-block; width:52px; height:7px; background:rgba(0,0,0,.08);
  border-radius:4px; overflow:hidden; vertical-align:middle; margin-right:5px; }
.vrbar i { display:block; height:100%; background:linear-gradient(90deg,#1a9e5a,#b8893b,#d8392b); }
.qtag { font-size:11px; padding:3px 8px; border-radius:10px; white-space:nowrap; font-weight:700; }
.qa { background:rgba(184,51,42,.12); color:#b8332a; border:1px solid rgba(227,154,140,.45); }
.qb { background:rgba(184,137,59,.14); color:#b8893b; border:1px solid rgba(184,137,59,.35); }
.qc { background:rgba(107,91,149,.14); color:#6b5b95; border:1px solid rgba(107,91,149,.30); }
.qd { background:rgba(141,168,148,.20); color:#1a9e5a; border:1px solid rgba(141,168,148,.40); }
.tabs { display:flex; gap:8px; margin:10px 0 4px; flex-wrap:wrap; }
.tab { background:rgba(0,0,0,.04); border:1px solid rgba(0,0,0,.06); color:#6b7280;
  font-size:13px; padding:6px 16px; border-radius:18px; cursor:pointer; transition:.2s; font-family:inherit; }
.tab:hover { background:rgba(184,137,59,.10); }
.tab.on { background:rgba(184,137,59,.20); border-color:rgba(184,137,59,.50); color:#1c2430; font-weight:700; }
...
.pill { background:rgba(0,0,0,.04); border:1px solid rgba(0,0,0,.06); color:#6b7280;
  font-size:12px; padding:5px 11px; border-radius:16px; cursor:pointer; transition:.18s;
  font-family:inherit; display:flex; align-items:center; gap:5px; }
.pill:hover { background:rgba(184,137,59,.08); border-color:rgba(184,137,59,.40); }
.pill.on { background:rgba(184,137,59,.22); border-color:rgba(201,166,107,.6); color:#1c2430; font-weight:700; }
.pn { font-size:10px; }
.grid3 { display:grid; grid-template-columns:repeat(auto-fit,minmax(470px,1fr)); gap:14px; margin-top:6px; }
.gcard { background:rgba(0,0,0,.03); border:1px solid rgba(0,0,0,.05); border-radius:14px; padding:12px 13px; }
.gcard h3 { margin:0 0 3px; font-size:14px; color:#1c2430; display:flex; align-items:center; gap:7px; }
.gcard h3 em { font-style:normal; font-size:11px; color:#8a929c; font-weight:400; }
.dot { width:8px; height:8px; border-radius:50%; display:inline-block; }
.d1 { background:#d8392b; } .d2 { background:#b8893b; } .d3 { background:#6b5b95; }
.rk3 { font-size:12px; }
...
.win { color:#b8893b; font-weight:800; } .avg { color:#b8893b; font-weight:800; }
.sortbar { display:flex; gap:6px; margin:7px 0 6px; }
.sbtn { background:rgba(0,0,0,.04); border:1px solid rgba(0,0,0,.06); color:#6b7280;
  font-size:11px; padding:3px 11px; border-radius:14px; cursor:pointer; font-family:inherit; transition:.2s; }
.sbtn:hover { background:rgba(184,137,59,.10); }
.sbtn.on { background:rgba(184,137,59,.22); border-color:rgba(184,137,59,.50); color:#1c2430; font-weight:700; }
.rowdet { background:rgba(201,166,107,.06); font-size:11px; color:#6b7280; }
.rowdet td { padding:7px 10px; }
.sbadge { display:inline-block; margin:2px 4px 2px 0; padding:2px 7px; border-radius:8px;
  background:rgba(0,0,0,.04); border:1px solid rgba(0,0,0,.06); font-size:11px; }
.empty { color:#8a929c; font-size:12px; padding:14px 4px; }
.legend { display:flex; flex-wrap:wrap; gap:12px; font-size:11px; color:#8a929c; margin-top:8px; }
